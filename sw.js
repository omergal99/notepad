...
const URLS_TO_CACHE = [
    ...
    './js/modules/StorageEngine.js',
    './js/modules/WindowManager.js',
    './js/modules/WindowComponent.js',
    './js/modules/TabManager.js',
    './js/modules/EditorComponent.js',
    './js/modules/PreferencesManager.js',
    './js/modules/ImageClipboardEngine.js',
    './js/modules/HistoryEngine.js',
    './js/modules/ExportEngine.js',
    './js/modules/SearchReplaceEngine.js',
    './js/modules/KeyboardShortcuts.js',
    './js/modules/ThemeEngine.js'
];
